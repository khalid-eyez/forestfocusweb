        ...
        <div class="row border-bottom">
          <?php include_once("topbar.php") ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><i class="fa fa-plus-circle"></i> Add New Post Section</h2>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <form action="postsectionsaver.php?post=<?=$_GET['post']?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10"><textarea name="text" class="form-control" rows=11 required></textarea></div>
                                </div>
