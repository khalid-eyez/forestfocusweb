<div id="inSlider" class="carousel slide" data-ride="carousel" style="margin-top:146px" >
    <?php
            ...
            $sql="select * from modules where moduleName='philosophy-activities';";
            $result=$conn->query($sql);
            $moduleID=$result->fetchAll(PDO::FETCH_ASSOC)[0]['modID'];

            $sql2="select * from modulecarousel where moduleID=".$moduleID.";";
