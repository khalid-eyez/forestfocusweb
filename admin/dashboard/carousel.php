        ...
        <div class="row border-bottom">
          <?php include_once("topbar.php") ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><i class="fa fa-edit"></i>Carousel</h2>
                        ...
                        <div class="ibox-content">
                              <div class="row">
                                  ...
                                  <p><?=$image['caption']?></p>
                                   ...
                                   <form action="carouselsaver.php" method="post" enctype="multipart/form-data">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.delimg').click(function(){
                 ...
                 var id=$(this).attr('id');
                 var img=$(this);
                 $.post("deletecarouselimage.php", {id: id}, function(result){
                        console.log(result);
                       if(result=='true')
                       {
                          img.parent().remove();
