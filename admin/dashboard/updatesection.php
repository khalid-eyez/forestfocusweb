...
<body class="no-skin-config">
    ...
    $sql="select * from sectionimages where sectionID=".$sectiondata['sectionID'].";";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <a class="btn btn-success m-1" href="deletesection.php?section=<?=$_GET['section']?>"> <i class="fa fa-trash float-right"></i> Delete Section</a>
                            <div class="ibox-tools">
                                
                            </div>
                        </div>
                        <div class="ibox-content">
                        <form action="sectionupdater.php?section=<?=$sec?>" method="post" enctype="multipart/form-data">
         
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Title</label>

                                <div class="col-sm-10"><input type="text" name="title" value="<?=$sectiondata['sectionTitle']?>" class="form-control" required></div>
                                </div>
